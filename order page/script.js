...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 0. CONFIGURATION
  // =====================================================
  const PRODUCT_PRICE = 1000; // DA

  // 5 models × 3 views
  const MODELS = {
    'Model A': {
      views: [
        { label: 'Front', src: 'images/model-a-front.png' },
        { label: 'Side',  src: 'images/model-a-side.jpeg'  },
        { label: 'Back',  src: 'images/model-a-back.png'  }
      ]
    },
    'Model B': {
      views: [
        { label: 'Front', src: 'images/model-b-front.png' },
        { label: 'Side',  src: 'images/model-b-side.png'  },
        { label: 'Back',  src: 'images/model-b-back.png'  }
      ]
    },
    'Model C': {
      views: [
        { label: 'Front', src: 'images/model-c-front.png' },
        { label: 'Side',  src: 'images/model-c-side.png'  },
        { label: 'Back',  src: 'images/model-c-back.png'  }
      ]
    },
    'Model D': {
      views: [
        { label: 'Front', src: 'images/model-d-front.png' },
        { label: 'Side',  src: 'images/model-d-side.png'  },
        { label: 'Back',  src: 'images/model-d-back.png'  }
      ]
    },
    'Model E': {
      views: [
